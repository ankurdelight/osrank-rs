...
pub trait LedgerView {
    ...
    fn get_param(&self, edge_type: &types::EdgeType) -> &Self::W {
        self.get_hyperparams().get_param(edge_type)
    }
        ...
        MockLedger {
            state: MockLedgerState {
                params: types::HyperParameters {
                    ...
                    r_value: 10,
                    edge_weights: [
                        (types::EdgeType::Contrib, Weight::new(1, 7)),
                        (types::EdgeType::ContribStar, Weight::new(2, 5)),
                        (types::EdgeType::Maintain, Weight::new(2, 7)),
                        (types::EdgeType::MaintainStar, Weight::new(3, 5)),
                        (types::EdgeType::Depend, Weight::new(4, 7)),
                    ]
                    .iter()
                    .cloned()
                    .collect(),
            ...
            state: MockLedgerState {
                params: types::HyperParameters {
                    ...
                    edge_weights: [
                        ...
                        (types::EdgeType::Depend, Weight::new(4, 7).as_f64().unwrap()),
                    ]
                    .iter()
                    .cloned()
                    .collect(),
